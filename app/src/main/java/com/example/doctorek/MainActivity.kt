...
class MainActivity : ComponentActivity() {
    ...
    fun DoctorekApp() {
        ...
        NavHost(
            ...
            // Appointment Confirmation Screen (if needed)
            composable(
                route = "appointmentConfirmation/{doctorId}",
                arguments = listOf(navArgument("doctorId") { type = NavType.StringType })
            ) { backStackEntry ->
                val doctorId = backStackEntry.arguments?.getString("doctorId") ?: ""
                // If you have a confirmation screen, add it here
                // Otherwise, this may be handled by the success dialog in PatientDetailsScreen
                // You can create a confirmation screen or just navigate to the home/appointments tab
...
sealed class Screens(val route: String) {
    ...
    object DoctorList : Screens("doctors_list")
